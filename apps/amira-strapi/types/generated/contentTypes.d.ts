...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    technicians: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCheckInCheckIn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    check_in_type: Schema.Attribute.Enumeration<['walk-in', 'appointment']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<'oneToMany', 'api::service.service'>;
    time_in: Schema.Attribute.DateTime & Schema.Attribute.Required;
    time_out: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServiceOrderServiceOrder
  ...
  attributes: {
    ...
    technician: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    time_end: Schema.Attribute.DateTime;
    time_start: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    body_part: Schema.Attribute.Enumeration<
      ['hands', 'feet', 'face', 'private']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
